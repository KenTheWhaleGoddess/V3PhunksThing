...
contract OpenEdition is Ownable, ERC1155Supply, ReentrancyGuard {
    ...
    bool public v3RequirementEnabled = true;
    address public v3phunks = 0xb7D405BEE01C70A9577316C1B9C2505F146e8842;
    address public charityProvider = 0xDF6e46d6a0999a5c0D19C094A11b9d4A03D9C3F9;

    mapping(address => mapping(uint256 => uint256)) public mintedByWalletPerEdition;

    mapping(uint256 => uint256) public ethRaisedPerEdition;

    mapping(uint256 => uint256) public ethWithdrawn;
    mapping(uint256 => uint256) public ethGivenToCharity;
    mapping(address => uint256) public charityToEthReceived;

    mapping(uint256 => DropDatas) public drops;
